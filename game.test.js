...
test('should consume stamina when attacking', () => {
    let perso1 = new Character('Brousse_Lit', 300, 15)
    let perso2 = new Character('Jicévédé', 300)

    perso1.attack(perso2)
    perso1.attack(perso2)
    perso1.attack(perso2)

    expect(perso1.tired).toBe(true)
...
test('two players should fight together', () => {
    let perso1 = new Character('Brousse_Lit', 10, 10)
    let perso2 = new Character('Jicévédé', 200, 10)
